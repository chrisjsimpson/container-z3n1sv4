...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z3n1sv4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z3n1sv4.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-z3n1sv4.git
cd container-z3n1sv4
```
...
```
docker attach container-z3n1sv4
```
